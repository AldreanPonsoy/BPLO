...
?>
	<tr scope="row">
                        ...
                        <th>
                            <a class="btn btn-primary" href="admin-ticket-edit.php?id=<?php echo $row['id']?>" class = "text-light">Open</a>
...
?>
	<tr scope="row">
                        ...
                        <th class="text-center"><?php echo $row['sdate'] ?></th>
                        <th>
                    <a class="btn btn-primary" href="admin-ticket-edit.php?id=<?php echo $row['id']?>" class = "text-light">Update</a>
                    <a class="btn btn-danger" href="admin-delete.php?id=<?php echo $row['id']?>" onclick="return confirm('Are you sure to delete?')">Delete</a>                         
                        </th>
