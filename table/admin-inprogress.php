<?php
	...
	if(ISSET($_POST['search'])){
		...
		$query=mysqli_query($conn, "SELECT * FROM ticketing where `status`='$progress' && date(`sdate`) BETWEEN '$date1' AND '$date2'") or die(mysqli_error());
...
<?php
        ...
        $progress = 'In progress';
		$query=mysqli_query($conn, "SELECT * FROM ticketing where `status`='$progress'") or die(mysqli_error());
