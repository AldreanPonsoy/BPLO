...
if(isset($_POST["submit"])) {
    ...
    if($result) {
        header("location: user_myticket.php?msg=Data update successfully");
    }
    else{
...
<header class="header">
		<h1 class="logo">
            <a href="add_new.php"><i class="fa fa-ticket" style="font-size25px;color:red"></i> Ticketing Tab</a>
        </h1>
        <ul class="main-nav">
    ...
    <div class="tickcontainer">
        ...
        <div class="ticketform justify-content-center">
            ...
            <div class="form-btn content">
                ...
                <a href="user_myticket.php" class="btn btn-danger">Cancel</a>
            </div>
            </form>
        </div>
    </div>
