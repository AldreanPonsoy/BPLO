...
if(isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `ticketing` SET `adminfix`='$adminfix',`feedback`='$feedback', `status`='$status'
    WHERE id=$id";
    ...
    if($result) {
        ...
        header("location:admin-index.php?msg=Data update successfully");
    }
    else{
    ...
    <div class="list">
        ...
        <div id="content"> 
            ...
            <div class="col">
                ...
                <textarea type="text" class="form-control" id="4" cols="55" rows="4" name="feedback" placeholder="Enter your Solution"></textarea>
            </div>
