...
<body>
    ...
    <div class="list">
        <div class="viewport" id="viewport">
                ...
                <ul class="nav">
                    <li>
                    <a  type="button" class="btn btn-success" href="user_index.php">Home</a>
                    <a   type="button" class="btn btn-success" href="user_updateprofile.php?id=<?php echo $_SESSION['username']?>">Update Profile</a>
