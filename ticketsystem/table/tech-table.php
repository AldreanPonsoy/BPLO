...
<?php
	...
	if(ISSET($_POST['search'])){
		...
		$query=mysqli_query($conn, "SELECT * FROM ticketing WHERE adminfix ='$id' && date(`sdate`) BETWEEN '$date1' AND '$date2'") or die(mysqli_error());
...
<?php
		...
		$id = $_SESSION['username'];
                $sql = "SELECT * FROM ticketing where adminfix ='$id'";
