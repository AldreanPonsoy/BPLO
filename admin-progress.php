...
<header class="header">
    ...
    <div class="list">
        <div class="viewport" id="viewport">
                ...
                <div class="sidebar">
                    <header>
                    <a href="">Progress TICKETS</a>
                    </header>
                    <div class="filters" id="filters">
                <ul class="nav">
                    <li>
                    
                    <a class="btn btn-success" href="admin-status.php">Pending Ticket</a>
                    <a class="btn btn-success" href="admin-progress.php">Progress Ticket</a>
                    <a class="btn btn-success"  href="admin-done.php">Done Ticket</a>
                ...
                <div id="content"> 
                    <div class="container-fluid">
                        ...
                        <a class="btn btn-success" style="float: left;" href="admin-update.php">Solve Tickets</a>
        ...
        <table class="table table-hover" id="my-table">
            ...
            <tbody class="myTable" >
                <?php include "table\admin-inprogress.php"; ?>                         
            </tbody>
        </table>
                    </div>
                </div>
